...
const props = withDefaults(
    defineProps<{
        logDate: string;
        messages: ChatLine[];
        chatAction: { url: string; method: 'post' | 'patch' | 'put' };
        hasDailyLog?: boolean;
        userName?: string;
        title?: string;
        placeholder?: string;
        emptyStateText?: string;
        showDebugReset?: boolean;
    }>(),
    {
        title: 'Chat',
        placeholder: 'Add update for this day',
        emptyStateText: 'No messages yet.',
        showDebugReset: false,
    },
);
...
<template>
    ...
    >
        ...
        >
            <div class="min-w-0">
                ...
                <input
                    ...
                    class="border-none bg-transparent p-0 text-sm font-semibold"
                    @change="onDateChange"
                />
            </div>
            <Form
            ...
            >
                ...
                <Button
                    ...
                    @click="
                        (event: MouseEvent) => {
                            if (!confirmDebugReset()) event.preventDefault();
                        }
                    "
                >
        ...
        <div class="border-b border-sidebar-border/70 p-4 dark:border-sidebar-border">
            <Form
                :key="logDate"
                :action="chatAction.url"
                :method="chatAction.method"
            ...
            >
                ...
                <div class="grid gap-2">
                    <Label for="dashboard-chat-input">Message</Label>
                    <textarea
